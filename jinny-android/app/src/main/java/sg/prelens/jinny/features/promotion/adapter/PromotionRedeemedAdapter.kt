...
import sg.prelens.jinny.features.promotion.viewholder.PromotionRedeemedViewHolder

class PromotionRedeemedAdapter(private val glide: RequestManager
                               , private val retryCallback: () -> Unit) : PromotionAdapter(glide,retryCallback){

    override  fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            R.layout.item_promotion -> PromotionRedeemedViewHolder.create(parent, glide)
