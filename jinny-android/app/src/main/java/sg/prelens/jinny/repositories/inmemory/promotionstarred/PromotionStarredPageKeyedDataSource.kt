 ...
 */
class PromotionStarredPageKeyedDataSource(private val api: ApiLink, private val retryExecutor: Executor, private val keyword: String, private val order: String) : PageKeyedDataSource<Int, PromotionList>() {
    ...
    override fun loadInitial(params: LoadInitialParams<Int>, callback: LoadInitialCallback<Int, PromotionList>) {
        val request = api.getStarredPromotions(
                keyword = keyword,
                page = 1,
