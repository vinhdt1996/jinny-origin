...
import android.view.*
import kotlinx.android.synthetic.main.fragment_cashback.*
...
class CameraCashBackFragment : Fragment(), View.OnClickListener,
        ActivityCompat.OnRequestPermissionsResultCallback {

    private val loadingProgress: Dialog by lazy {
        Dialog(this@CameraCashBackFragment.requireContext())
    }
    ...
    private val stateCallback = object : CameraDevice.StateCallback() {
        ...
        override fun onOpened(cameraDevice: CameraDevice) {
            ...
            this@CameraCashBackFragment.cameraDevice = cameraDevice
        ...
        override fun onDisconnected(cameraDevice: CameraDevice) {
            cameraOpenCloseLock.release()
            cameraDevice.close()
            this@CameraCashBackFragment.cameraDevice = null
        }

        override fun onError(cameraDevice: CameraDevice, error: Int) {
            onDisconnected(cameraDevice)
            this@CameraCashBackFragment.activity?.finish()
        }
    }
    ...
    ): View? = inflater.inflate(R.layout.fragment_cashback, container, false)
...
//        view.findViewById<View>(R.id.info).setOnClickListener(this)
    ...
    private fun setUpCameraOutputs(width: Int, height: Int) {
        ...
        try {
            for (cameraId in manager.cameraIdList) {
                ...
                val list = Arrays.asList(*map.getOutputSizes(ImageFormat.JPEG))
                val largest = list[list.size / 2]
    ...
    /**
     * Opens the camera specified by [CameraCashBackFragment.cameraId].
     */
...
//                    backgroundHandler)
    ...
    private fun runPrecaptureSequence() {
        try {
            ...
            if (activity == null || cameraDevice == null || backgroundHandler == null) return
            captureSession?.capture(previewRequestBuilder.build(), captureCallback,
                    backgroundHandler)
        } catch (e: CameraAccessException) {
            Log.e(TAG, e.toString())
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(id: String, usersVoucherId: Int): CameraCashBackFragment {
            val fragment = CameraCashBackFragment()
            fragment.id = id
