...
class VoucherPurchasedHistoryPageKeyedDataSource(
        private val voucherHistoryApi: ApiLink,
    ...
    override fun loadInitial(params: LoadInitialParams<Int>, callback: LoadInitialCallback<Int, CashBackHistory>) {
        val request = voucherHistoryApi.fetchVouchersHistory(
                page = 0,
    ...
    override fun loadAfter(params: LoadParams<Int>, callback: LoadCallback<Int, CashBackHistory>) {
        networkState.postValue(NetworkState.LOADING)
        voucherHistoryApi.fetchVouchersHistory(
                page = params.key,
