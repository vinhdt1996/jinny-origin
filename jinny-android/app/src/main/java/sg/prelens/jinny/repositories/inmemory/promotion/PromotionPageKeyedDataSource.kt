 ...
 */
class PromotionPageKeyedDataSource(private val api: ApiLink, private val retryExecutor: Executor, private val keyword: String, private val order: String) : PageKeyedDataSource<Int, PromotionList>() {
